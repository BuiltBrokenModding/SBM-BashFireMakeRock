...
public class ClickData
{
    ...
    public boolean click()
    {
        ...
        if (diff >= ConfigMain.DELAY.minimalDelay * 1000)
        {
            timesClicked++;
            lastTimeClicked = System.currentTimeMillis();
            if (timesClicked > ConfigMain.numberOfClickBeforeChance)
            {
                return random.nextInt(ConfigMain.chancePerClick) == 0;
            }
        }
        return false;
    }
    ...
    {
        return System.currentTimeMillis() - lastTimeClicked > ConfigMain.DELAY.maxDelay * 1000;
    }
